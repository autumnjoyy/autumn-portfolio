...
const Resume = () => {
  return (
    <section className="px-6 py-12 max-w-4xl mx-auto" id="resume">
      ...
      {/* Experience */}
      <div className="mb-8">
        <h3 className="text-2xl font-semibold mb-4">Experience & Activities</h3>

        {/* Theater & Performance */}
        <div className="mb-4">
          <h4 className="text-xl font-medium text-blue-600">Theater & Performance</h4>
        ...
        {/* Leadership */}
        <div className="mb-4">
          <h4 className="text-xl font-medium text-blue-600">Leadership & Awards</h4>
          <ul className="list-disc list-inside text-gray-700">
        ...
        {/* Service */}
        <div className="mb-4">
          <h4 className="text-xl font-medium text-blue-600">Service & Volunteering</h4>
          <ul className="list-disc list-inside text-gray-700">
        ...
        {/* Health & Education */}
        <div className="mb-4">
          <h4 className="text-xl font-medium text-blue-600">Health & Education</h4>
          <ul className="list-disc list-inside text-gray-700">
      ...
      {/* Athletics */}
      <div className="mb-8">
        <h3 className="text-2xl font-semibold mb-2">Athletics & Achievements</h3>
        <ul className="list-disc list-inside text-gray-700">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-700"><strong>Josh’s Sno Shack</strong> – Employee (Mar 2023–Present)</p>
      </div>

      {/* Education */}
      <div>
        <h3 className="text-2xl font-semibold mb-2">Education</h3>
        <p className="text-gray-700">Regent Preparatory School, Tulsa, OK<br />Expected Graduation: 2025</p>
      </div>
    </section>
  );
};
